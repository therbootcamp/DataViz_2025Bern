...
1. If you haven't done so already, load the `tidyverse` and `patchwork` package. Also load the `taxation.csv` data into an object called `basel`.
...
1. Play around and create a different plot using the `taxation` data. Maybe a barplot or lollipop plot of the richest quarters? 
