...
2. Add the following code to show a Table of Contents and change the Title to `Contents`
...
### 4 - Add a table in the Appendix showing data for Altstadt Grossbasel
