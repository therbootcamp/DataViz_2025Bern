...
The `imdb.csv` data set contains the **1000 highest rated movies** on the movie platform 'Internet Movie Database' (IMDb, https://imdb.com/). 
...
1. Think about **a question** that may lead to an interesting insight about the data. Below are a few ideas; however, note that some require more serious data processing. 
Feel free to choose a question of your own. Use either only the `imdb` or the `imdb` and `oscars` data sets. 
...
- Are movies that receive more positive ratings grossing more revenue?
- Which actor pairs appear often together? 

2. Spend **5-10 minutes to sketch out** how a plot that effectively addresses your question might look like. You can do this on a piece of paper or a program like keynote or powerpoint.
